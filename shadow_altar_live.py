#!/usr/bin/env python3
"""
SHΔDØW‑FB‑FORGE · LIVE OTP RITUAL (PLAYWRIGHT DEFAULT BROWSER)
Educational tool — use ONLY on authorized targets.
Playwright downloads Chromium at build time – no system binary needed.
"""

import os, time, random, threading, re, logging, uuid
...
# ---------- BROWSER POOL (NO EXECUTABLE PATH) ----------
class BrowserForge:
